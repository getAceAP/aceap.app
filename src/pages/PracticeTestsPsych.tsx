...
const PracticeTestsPsych = () => {
  useTitle("AP Psychology Practice Tests");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-16 sm:py-24 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
            Unit quizzes plus a full-course practice exam with research-style stimuli.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-12 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-4">
          {psychologyUnits.map((unit, i) => (
            ...
            >
              <Link
                to={`/units/ap-psych/quiz/${unit.id}`}
              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                    <Clock size={14} />
                    {unit.period} of the exam · {unit.questions.length} questions
                  </p>
                </div>
          ...
          >
            <Link
              to={`/units/ap-psych/quiz/${PSYCH_REVIEW_SLUG}`}
            ...
            >
              ...
              <div className="flex-1 min-w-0 space-y-1">
                <h2 className="text-xl font-bold tracking-tight text-foreground group-hover:text-primary transition-colors">
                  Full Course Practice Exam
                </h2>
                <p className="text-sm text-muted-foreground">Mixed questions across all five units.</p>
              </div>
              <span className="inline-flex items-center font-bold text-sm text-primary shrink-0">
                Start quiz
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
...
export default PracticeTestsPsych;

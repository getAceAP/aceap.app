...
const FlashcardsPrecalc = () => {
  useTitle("AP Precalculus Flashcards");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-16 sm:py-24 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
            Formula and identity cards for the three exam units — drill what you need before a calculator-active set.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-12 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-4">
          {precalcUnits.map((unit, i) => (
            ...
            >
              <Link
                to={`/units/ap-precalc/flashcards/${unit.id}`}
...
export default FlashcardsPrecalc;

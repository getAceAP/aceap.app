...
import { ArrowRight, BookOpen, Brain, Calculator, Layers } from "lucide-react";
import { motion } from "framer-motion";
import { useTitle } from "@/hooks/useTitle";
import { courseCovers, flashcardsHero } from "@/data/course-covers";

const courses = [
  {
    id: "ap-world",
    title: "AP World History",
    blurb: "Key terms and concepts for every unit — flip, type, or scan the list before a quiz.",
    units: "9 unit decks",
    href: "/flashcards/ap-world",
    image: courseCovers["ap-world"],
  },
  {
    id: "ap-psych",
    title: "AP Psychology",
    blurb: "Vocab decks for each CED unit plus a combined full-course review deck.",
    units: "5 units + full review",
    href: "/flashcards/ap-psych",
  ...
  return (
    <Layout wide>
      <section className="relative overflow-hidden">
        <img src={flashcardsHero} alt="" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-20 sm:py-28 text-center space-y-6">
          ...
          >
            Cards built for retrieval, not rereading
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Open a course deck, practice with hints, and mark what you know. Guests get 5 free cards — create an account for the full set.
          </motion.p>
        </div>
      </section>

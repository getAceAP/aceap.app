...
const GuidesWorld = () => {
  useTitle("AP World History Study Guides");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-16 sm:py-24 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
            Unit reviews written for the CED, not a rewritten textbook. Open any guide in the library when you are ready to read.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-12 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-4">
          {units.map((unit, i) => (
              ...
              >
                <Link
                  to={`/units/ap-world/guide/${unit.id}`}

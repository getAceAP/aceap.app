...
const PracticeTestsWorld = () => {
  useTitle("AP World History Practice Tests");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-16 sm:py-24 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
            Stimulus-based quizzes for each unit. Study mode explains misses; exam mode runs the clock.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-12 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-4">
          {units.map((unit, i) => (
            ...
            >
              <Link
                to={`/units/ap-world/quiz/${unit.id}`}
              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                    <Clock size={14} />
                    {unit.period} · {unit.questions.length} questions in bank
                  </p>
                </div>
...
export default PracticeTestsWorld;

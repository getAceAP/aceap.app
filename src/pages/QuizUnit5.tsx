...
const stimuli = [
  ...
  { id: 2, text: "Men are born and remain free and equal in rights. Social distinctions may be founded only upon the general good... The aim of all political association is the preservation of the natural and imprescriptible rights of man.", source: "Declaration of the Rights of Man and of the Citizen, 1789" },
  { id: 3, text: "I have undertaken vengeance. I want Liberty and Equality to reign in San Domingo. I am working to make them exist. Unite yourselves to us, brothers, and fight with us for the same cause.", source: "Toussaint L'Ouverture, Proclamation to the People of Saint-Domingue, 1793" },
  { id: 4, text: "The greatest improvement in the productive powers of labour, and the greater part of the skill, dexterity, and judgment with which it is any where directed, or applied, seem to have been the effects of the division of labour.", source: "Adam Smith, The Wealth of Nations, 1776" },
  { id: 5, text: "Knowledge shall be sought throughout the world so as to strengthen the foundation of imperial rule... All classes, high and low, shall unite in vigorously carrying out the administration of affairs of state.", source: "The Charter Oath of the Meiji Restoration, 1868" },
  { id: 6, text: "It is not from the benevolence of the butcher, the brewer, or the baker that we expect our dinner, but from their regard to their own interest. We address ourselves, not to their humanity but to their self-love.", source: "Adam Smith, The Wealth of Nations, 1776" },
  { id: 7, text: "The history of all hitherto existing society is the history of class struggles... The proletarians have nothing to lose but their chains. They have a world to win. Working Men of All Countries, Unite!", source: "Karl Marx and Friedrich Engels, The Communist Manifesto, 1848" },
  { id: 8, text: "The town itself is peculiarly built, so that a person may live in it for years... without coming into contact with a working-people's quarter or even with workers, so long as he confines himself to his business or to pleasure walks.", source: "Friedrich Engels, The Condition of the Working Class in England, 1845" },
  { id: 9, text: "The price which society pays for the law of competition... is also great; but the advantages of this law are also greater still, for it is to this law that we owe our wonderful material development.", source: "Andrew Carnegie, The Gospel of Wealth, 1889" },
...
const questions = [
  ...
  { id: 5, stimulusId: 1, question: "What was a major social consequence of Enlightenment thought regarding 'liberty'?", options: ["The rise of slavery", "The abolitionist movement", "The end of trade", "The fall of the Church"], correctAnswer: "The abolitionist movement", explanation: "The focus on individual rights and equality led many to question and oppose the institution of slavery." },
  { id: 6, stimulusId: 2, question: "Which group made up the 'Third Estate' that fought for these rights in France?", options: ["The Clergy", "The Nobility", "The Commoners", "The Royal Family"], correctAnswer: "The Commoners", explanation: "The Third Estate included peasants, artisans, and the bourgeoisie, making up 97% of the population." },
  ...
  { id: 16, stimulusId: 4, question: "The 'division of labour' described by Smith is a core feature of:", options: ["Cottage Industry", "The Factory System", "Feudalism", "Mercantilism"], correctAnswer: "The Factory System", explanation: "Factories divided tasks into simple, repetitive steps to increase efficiency." },
  ...
  { id: 21, stimulusId: 5, question: "The Meiji Restoration was a response to which event?", options: ["The Opium War", "The arrival of Commodore Matthew Perry", "The French Revolution", "The Black Death"], correctAnswer: "The arrival of Commodore Matthew Perry", explanation: "Perry's arrival in 1853 forced Japan to open its ports and realize its technological disadvantage." },

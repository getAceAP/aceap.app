...
const GuidesPsych = () => {
  useTitle("AP Psychology Study Guides");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-16 sm:py-24 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
            Five CED units plus a full-course pass. Each guide opens in your library next to the matching cards and quizzes.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-12 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-4">
          {psychologyUnits.map((unit, i) => (
            ...
            >
              <Link
                to={`/units/ap-psych/guide/${unit.id}`}
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0 space-y-1">
                ...
                <p className="text-sm text-muted-foreground">All five units in one sitting.</p>
              </div>
              <span className="inline-flex items-center font-bold text-sm text-primary shrink-0">
                Open in library
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />

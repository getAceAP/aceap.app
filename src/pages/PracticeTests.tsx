...
import { ArrowRight, BookOpen, Brain, Calculator, ListChecks } from "lucide-react";
import { motion } from "framer-motion";
import { useTitle } from "@/hooks/useTitle";
import { courseCovers, practiceHero } from "@/data/course-covers";

const courses = [
  {
    id: "ap-world",
    title: "AP World History",
    blurb: "Stimulus-based unit quizzes across all nine periods — study mode with explanations or timed exam mode.",
    units: "9 unit quizzes",
    href: "/practice-tests/ap-world",
    image: courseCovers["ap-world"],
  },
  {
    id: "ap-psych",
    title: "AP Psychology",
    blurb: "Unit quizzes plus a full-course practice set with research-style stimuli.",
    units: "5 units + full review",
    href: "/practice-tests/ap-psych",
    image: courseCovers["ap-psych"],
  },
  {
    id: "ap-precalc",
    title: "AP Precalculus",
    blurb: "Generated practice for the three exam units — calculator and no-calculator items mixed in.",
    units: "3 exam units",
    href: "/practice-tests/ap-precalc",
    image: courseCovers["ap-precalc"],
  },
];

const PracticeTests = () => {
  useTitle("Practice Tests");

  return (
    <Layout wide>
      <section className="relative overflow-hidden">
        <img src={practiceHero} alt="" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-20 sm:py-28 text-center space-y-6">
          ...
          >
            Quizzes that feel like the real exam
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Pick a course, open a unit, and run study mode or timed exam mode. Guests get 5 free questions — sign up for unlimited practice.
          </motion.p>
        </div>
      </section>

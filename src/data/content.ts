...
export const units: Unit[] = [
  {
    ...
    flashcards: [
      { id: "u1-f1", prompt: "Song Dynasty (960-1279 CE)", answer: "The Chinese dynasty that placed much more emphasis on civil administration, industry, education, and arts other than military." },
      ...
      { id: "u1-f21", prompt: "Heian Period (794 - 1100)", answer: "move the capital to Heian; 300 years of developing a new culture; growth of large estates; arts and literature of china flourished; elaborate court life; personal diaries (pillow book and the take of genji); moved away from chinese culture" },
      ...
      { id: "u1-f27", prompt: "Abbasid Caliphate (750-1258 CE)", answer: "The caliphate, after the Umayyads, who focused more on administration than conquering. Had a bureaucracy that any Muslim could be a part of." },
      ...
      { id: "u1-f39", prompt: "Delhi Sultanate (1206-1526 CE)", answer: "The successors of Mahmud of Ghazni who directed their goals to creating this empire in India." },
